...
<meta name="google-translate-customization" content="9fcc5aa9f474d24a-a197590c3011f9b4-g0412b4d3e2682000-14" />
...
<meta charset="utf-8" />
<meta property="fb:admins" content="1414912982105983" /><meta name="rating" content="general" />
...
<link rel="stylesheet" href="/css/stylesPrint.css" type="text/css" media="print" />
...
<meta name="dcterms.Title" lang="DE" content="{title_html_de}" />
<meta name="dcterms.Subject" lang="DE" content="Youtube zu MP3 Konverter" />
<meta name="dcterms.Publisher" content="Youtube-MP3.MOBI, Ltd." />
<meta name="dcterms.Type" content="text/html" />
<meta name="dcterms.Description" lang="DE" content="{description_de}" />
...
<div class="content" id="target">
	<h1 itemprop="headline" id="description" class="fn"><strong><b>{yt_title}</b></strong></h1>
	<br />
	<a name="top"></a>
	<form method="GET" action="/songtext.php">
		<input type="text" name="lyrics" id="video" size="45" value="Songtexte suchen oder Youtube umwandeln" onblur="if (this.value == '') {this.value = 'Songtexte suchen oder Youtube umwandeln';}" onfocus="if (this.value == 'Songtexte suchen oder Youtube umwandeln') {this.value = '';}" autocomplete="on" required />
		<input type="hidden" name="language" value="DE" />
		<input type="submit" value="Los Legen (!)" class="button" />
	</form>
	<br /><br />
	<span itemscope itemtype="http://schema.org/MusicRecording" class="haudio">
		<h2><span itemprop="byArtist" class="contributor">{songtext_artist}</span> - <strong>Songtext <b itemprop="name" class="fn">{songtext_title}</b> Lyrics</strong>{duration}<br /><a itemprop="url" href="{canonical_tag}">Inoffizielle Webseite</a> - Hier kannst du das offizielle Full HD Video sehen: <a class="url" href="/search.php?video={songtext_title_search}" rel="search" itemprop="url" title="Schau das {songtext_title} Youtube Video in Full HD 1080p">Video in Full HD angucken</a>
		</h2>
	</span> 	
	<span style="font-size:16px;" lang="{songtext_lang}" class="drucker" itemprop="description">
		<h3>{songtext_content}</h3>
		<br />
		<a href="javascript:window.print()" rel="nofollow"><img src="/images/printer_small.png" width="22" height="22" border="0" alt="Songtext ausdrucken">Liedtext drucken</a>
		&nbsp;♥&nbsp;
		<a class="url" href="https://plus.google.com/102814280381371438232?rel=author" rel="nofollow">Google+</a>
		&nbsp;♥&nbsp;
		<a class="url invisible" href="#top" rel="nofollow" style="text-align:center; margin:0 auto">gehe nach oben</a>	
		<br /><br />
		<h4><strong><b>
...
auf Google Plus&nbsp;♥&nbsp;, share auf Pinterest&nbsp;♥&nbsp; und zwitschere auf Twitter&nbsp;♥&nbsp; über uns.
			<br /><br />
			<div class="fb-like invisible" rel="nofollow" data-href="https://www.facebook.com/YoutubeConverter" data-layout="standard" data-action="like" data-show-faces="false" data-share="true"></div>
			<div class="fb-comments invisible" data-href="{canonical_tag}" rel="nofollow" data-width="450" data-numposts="3" data-colorscheme="light"></div>
		</b></strong></h4>
	<br />
	</span> 

	<span itemscope itemtype="http://schema.org/WebApplication" class="invisible">
    	<br />
		<h4 class="invisible"><strong><b><span lang="de">Songtexte</span> · <span lang="en">Lyrics</span> · <span lang="de">Liedtexte</span> · <span lang="es">Letras de canciones · Letras de canções</span> · <span lang="fr">Paroles de chanson</span> · <span lang="fr">Lyrique</span> · <span lang="nl">Songteksten</span> · <span lang="gr">στιχοι</span> · <span lang="ru">тексты песен</span> · <span lang="ae">القصائد الغناءيه</span> · <span lang="th">เนื้อเพลง </span>· <span lang="ja">リリック</span> · <span lang="ko">가사</span> · <span lang="zh">叙情詩 · 抒情歌 · 歌詞 · 歌词</span></b></strong>
		</h4>
		<br />
		&copy; 2014 - www.youtube-mp3.mobi &nbsp;-&nbsp;<a href="https://www.buzzerstar.com/" hreflang="de" target="_blank">Funny Videos</a> - <a
...
href="https://www.buzzerstar.com/development/">Technologie</a> - <a href="https://blog.onetopp.com/" hreflang="en" target="_blank">Technology Blog</a> - <a href="https://www.onetopp.com/" hreflang="en" target="_blank">Innovation</a> - <a href="https://devop.tools/" hreflang="de" target="_blank">Devops</a><a class="url" href="/imprint.php" rel="nofollow" target="_blank" itemprop="url">Impressum</a> - <a class="url" href="/privacy-policy.php" rel="nofollow" target="_blank" itemprop="url">Privacy Policy</a>
		<br />
		<h5>
			<span class="invisible">
				Wir nutzen folgende Tools: 
				<br />
				<a class="url" href="https://github.com/thecerial/iosec_addons" target="_blank" itemprop="url" hreflang="en">Github IOSEC Addons</a> -
				<a class="url" href="http://sourceforge.net/u/sebastianenger/profile/" itemprop="url" target="_blank" hreflang="en">SourceForge</a>		
					
				<br />
					<div id="google_translate_element"></div>
					<script type="text/javascript">
						function googleTranslateElementInit() {
						  new google.translate.TranslateElement({pageLanguage: 'de', multilanguagePage: true, gaTrack: true, gaId: 'UA-49319016-1'}, 'google_translate_element');
						}
