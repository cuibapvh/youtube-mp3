...
<meta name="keywords" content="{keyword_en}, youtube converter, download youtube mp3" />
...
<meta name="DC.Title" xml:lang="EN" content="{title_html_en}" />
<meta name="DC.Subject" xml:lang="EN" content="Youtube MP3 Converter" />
<meta name="DC.Publisher" content="Youtube-MP3.MOBI, Ltd." />
<meta name="DC.Date" scheme="ISO8601" content="2014-03-06" />
<meta name="DC.Type" content="text/html" />
<meta name="DC.Description" xml:lang="EN" content="{description_en}" />
...
<div class="content">
	<ul style="list-style: none;" id="target_search">
		<h1 itemprop="headline" class="fn"><strong><b>{title_content} as 320 Kbit/s MP3 Download with Lyrics</b></strong></h1>
		<br />
		<noscript>
		...
		<li>Song Category: {category_content}</li>
		<li>Video Length: {lenght_content} Sekunden</li>
		<li>Music Video Views: {views_content}</li>
		<li>
			<br /><br />
			<strong><b>
...
<ul>
	...
	<script type="text/javascript">
		function addLink() {
			...
			var pagelink = "<br /><br /> More Youtube Converter News and MP3 Downloads on: <a href='http://www.youtube-mp3.mobi/en/' hreflang='en'>Youtube Mp3 Converter</a> - <a href='"+document.location.href+"'>"+document.location.href+"</a>";
