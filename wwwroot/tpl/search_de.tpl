...
<div class="content" id="target_search">
			<h1 id="description" itemprop="headline"><strong><b><a class="url" href="http://www.youtube-mp3.mobi/" itemprop="url" rel="me" class="fn">{yt_title}</a></b></strong></h1>
			<a itemprop="headline" class="url fn" href="http://www.youtube-mp3.mobi/" title="Youtube MP3 Umwandeln - Videos kostenlos zu MP3 konvertieren und mit Songtext & Lyrics downloaden"><img src="/images/logo_de.png" class="photo" alt="Youtube zu Mp3 Konverter" /></a>
    	...
    	<br />
		<ul itemscope itemtype="http://schema.org/WebApplication">
			<li>
				<h5><strong><b><span lang="de">Songtexte</span> · <span lang="en">Lyrics</span> · <span lang="de">Liedtexte</span> · <span lang="es">Letras de canciones · Letras de canções</span> · <span lang="fr">Paroles de chanson</span> · <span lang="fr">Lyrique</span> · <span lang="nl">Songteksten</span> · <span lang="gr">στιχοι</span> · <span lang="ru">тексты песен</span> · <span lang="ae">القصائد الغناءيه</span> · <span lang="th">เนื้อเพลง </span>· <span lang="ja">リリック</span> · <span lang="ko">가사</span> · <span lang="zh">叙情詩 · 抒情歌 · 歌詞 · 歌词</span></b></strong>
				</h5>
				<br />
...
href="https://www.buzzerstar.com/development/">Technologie</a> - <a href="https://blog.onetopp.com/" hreflang="en" target="_blank">Technology Blog</a> - <a href="https://www.onetopp.com/" hreflang="en" target="_blank">Innovation</a> - <a href="https://devop.tools/" hreflang="de" target="_blank">Devops</a><a class="url" href="/imprint.php" rel="nofollow" target="_blank" itemprop="url">Impressum</a> - <a class="url" href="/privacy-policy.php" rel="nofollow" target="_blank" itemprop="url">Privacy Policy</a>
	...
	<li>
		<a href="http://feeds.feedburner.com/Youtube-mp3mobiAudioDownloadNeuigkeiten" class="url" itemprop="url" rel="nofollow"><img src="http://feeds.feedburner.com/~fc/Youtube-mp3mobiAudioDownloadNeuigkeiten?bg=99CCFF&amp;fg=444444&amp;anim=1&amp;label=listeners" height="26" width="88" style="border:0" class="photo" alt="FeedBurner von Youtube-MP3.Mobi abonnieren" /></a>
	</li>
	<li>
	<script type="text/javascript">
		function addLink() {
